				...
				{elseif $key == 'input'}
					...
					{foreach $field as $input}
						...
						{elseif $input.type == 'infoheadingsmall'}
							<div class="infoheadingsmall_class col-sm-12 {if isset($input.colorclass)}{$input.colorclass}{/if} " data-name="{$input.name}" id="{$input.name}">
								<h4 class="infoheadingsmall_label" style="font-size:16px; border-bottom:1px solid #ccc;font-weight: 600;padding-bottom: 5px;">{$input.label}</h4>
								{if isset($input.sublabel)}
							...
							{block name="field"}
								...
								<div class="support-section">
									<div id="support" class="support-div">
										<h4>Support</h4>
										<p>When you face problems or need to ask anything about the theme, you can contact our support email: <span class="email">posthemes@gmail.com</span>
									</div>
									<div id="custom" class="support-div">
										<h4>Customwork</h4>
										<p>When need to make a customized work, you can contact the developer email: <span class="email">posthemes.development@gmail.com</span>
										<div id="questions">
											<h4>Frequently Asked Questions</h4>
											<p class="question"><strong>Q. How much do you usually charge?</strong></p>
											<p class="answer"><strong>A.</strong> Every project is unique, and the quote depends on the requirements &amp; complexity of the project. The price per hour is from 20$/hour</p>
											<p class="question"><strong>Q. What are the payment terms?</strong></p>
											<p class="answer"><strong>A.</strong> Payment is 50% upfront and 50% on the completion of the project.</p>
											<p class="question"><strong>Q. How long will it take to complete my project?</strong></p>
											<p class="answer"><strong>A. </strong>The completion time of customwork will depend on various factors like the complexity of design, the number of pages, and functions . Therefore, we can tell you the turnaround time only after understanding your requirements. Usually it takes us 7 to 14 days for coding to perfection.</p>
											<p class="question"><strong>Q. What methods of payment do we accept?</strong></p>
											<p class="answer"><strong>A.</strong>We accept payment via Paypal only</p>
											<p class="question"><strong>Q. Do you offer support after a project is completed?</strong></p>
											<p class="answer"><strong>A.</strong> Bug fixes and minor tweaks are always included in support. Additions and sizable changes will be quoted separately.</p>
											<p class="question"><strong>Q. How do you handle the refunds?</strong></p>
											<p class="answer"><strong>A.</strong> We issue the refund only in the following situations:</p>
											<ul class="text-list">
											<li>If we fail to deliver the project on time.</li>
											<li>If you withdraw the project before it gets started.</li>
											<li>If you are not satisfied with the final result and our attempts to meet your needs are not successful.</li>
											</ul>
											<p><strong>Note:</strong> We will not issue a refund after the final zip is delivered. The final zip will be delivered only when you are completely satisfied with our work.</p>
										</div>
									</div>
								</div>
